...
def check_account_age(repo: dict) -> int:
    """If owner account is younger than 6 months, deduct 10 points."""
...
def check_has_ci(repo: dict) -> int:
    """Check if repo has .github/workflows directory. Returns 5 if yes, 0 otherwise."""
    ...
    url = f"{GITHUB_API}/repos/{full_name}/contents/.github/workflows"
