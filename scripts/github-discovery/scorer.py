...
from anti_spam import calculate_antiscore, check_has_ci

# Hot languages get a quality bonus
HOT_LANGUAGES = {"python", "typescript", "rust", "go", "javascript", "java", "c++", "kotlin"}
